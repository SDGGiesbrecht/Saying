  ...
  static func rescaffold(
    ...
    try Swift.prepare(
      ...
      entryPoints: [
        ...
        "ParsedDownArrowSyntax.type",
        "ParsedLeftArrowSyntax.type",
        "ParsedRightArrowSyntax.type",
        "ParsedClosingBraceSyntax.type",
        "ParsedOpeningBraceSyntax.type",
        "ParsedClosingBracketSyntax.type",
        "ParsedOpeningBracketSyntax.type",
        "ParsedClosingParenthesisSyntax.type",
        "ParsedOpeningParenthesisSyntax.type",
        "ParsedLineBreakSyntax.type",
        "ParsedParagraphBreakSyntax.type",
        "ParsedBulletCharacterSyntax.type",
        "ParsedOpeningQuestionMarkSyntax.type",
        "ParsedClosingQuestionMarkSyntax.type",
        "ParsedRightToLeftQuestionMarkSyntax.type",
        "ParsedGreekQuestionMarkSyntax.type",
        "ParsedOpeningExclamationMarkSyntax.type",
        "ParsedClosingExclamationMarkSyntax.type",
        "ParsedColonCharacterSyntax.type",
        "ParsedLeftChevronQuotationMarkSyntax.type",
        "ParsedLowQuotationMarkSyntax.type",
        "ParsedNinesQuotationMarkSyntax.type",
        "ParsedRightChevronQuotationMarkSyntax.type",
        "ParsedSixesQuotationMarkSyntax.type",
        "ParsedSlashSyntax.type",
        "ParsedSpaceSyntax.type",
        "ParsedSymbolInsertionMarkSyntax.type",
      ],
